        ...
        render: function (container) {
            ...
            if (container) {
                ...
                var html = ( ie && browser.version < 9  ? '' : '<!DOCTYPE html>') +
                    ...
                    //设置段落间距
                    'p{margin:5px 0;}img{width:100%;}</style>' +
...
//            }
		...
		function sendAndInsertFile(file, editor) {
			...
			if (filetype == 'image') {
				loadingHtml = '<img class="loadingclass" id="' + loadingId + '" src="' +
					'http://asset.sunjay.cn/editor/style/images/spacer.gif" title="' + (me.getLang('autoupload.loading') || '') + '" >';
					...
					if(window.FormData && window.FileReader) {
						...
						utils.cssRule('loading',
							'.loadingclass{display:inline-block;cursor:default;background: url(\''
								+ 'http://asset.sunjay.cn/editor/style/images/loading.gif\') no-repeat center center transparent;border:1px solid #cccccc;margin-left:1px;height: 22px;width: 22px;}\n' +
								'.loaderrorclass{display:inline-block;cursor:default;background: url(\''
								+ 'http://asset.sunjay.cn/editor/images/loaderror.png\') no-repeat center center transparent;border:1px solid #cccccc;margin-right:1px;height: 22px;width: 22px;' +
								'}',
							this.document);
					}
				}
		...
		function initUploadBtn(){
			...
			domUtils.on(btnIframe, 'load', function(){
				...
				domUtils.on(input, 'change', function(){
					...
					me.focus();
					me.execCommand('inserthtml', '<img class="loadingclass" id="' + loadingId + '" src="http://asset.sunjay.cn/editor/style/images/spacer.gif" title="' + (me.getLang('simpleupload.loading') || '') + '" >');
		...
		return {
			bindEvents:{
				'ready': function() {
					...
					utils.cssRule('loading',
						'.loadingclass{display:inline-block;cursor:default;background: url(\''
						+ 'http://asset.sunjay.cn/editor/style/images/loading.gif\') no-repeat center center transparent;border:1px solid #cccccc;margin-right:1px;height: 22px;width: 22px;}\n' +
						'.loaderrorclass{display:inline-block;cursor:default;background: url(\''
						+ 'http://asset.sunjay.cn/editor/style/images/loaderror.png\') no-repeat center center transparent;border:1px solid #cccccc;margin-right:1px;height: 22px;width: 22px;' +
						'}',
						this.document);
				},
				/* 初始化简单上传按钮 */
	...
	(function () {
		...
		UE.ui.Editor = function (options) {
			...
			utils.loadFile(document, {
				href:"http://asset.sunjay.cn/editor/style/css/ueditor.css",
				tag:"link",
				type:"text/css",
				rel:"stylesheet"
			});
